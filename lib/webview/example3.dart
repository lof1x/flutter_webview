...
class WebExampleOne extends StatefulWidget {
  final String url;
  WebExampleOne({Key? key, required this.url}) : super(key: key);

  @override
  _WebExampleTwoState createState() => _WebExampleTwoState();
}

class _WebExampleTwoState extends State<WebExampleOne> {
                ...
                children: [
                  InAppWebView(
                    ...
                    initialUrlRequest: URLRequest(
                      url: Uri.parse('https://cleaner192.github.io/KZHyberSportLearningFront/#/'),
                      headers: {},
